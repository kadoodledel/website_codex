...
/* Zusätzliche Härtung gegen WPForms-Default-Layout (Vorname/Nachname Versatz) */
#wpforms-form-1815 .wpforms-field-name .wpforms-field-row,
#wpforms-form-1843 .wpforms-field-name .wpforms-field-row {
  display: grid !important;
  grid-template-columns: 1fr 1fr !important;
  gap: 12px !important;
}
#wpforms-form-1815 .wpforms-field-name .wpforms-field-row .wpforms-field-row-block,
#wpforms-form-1843 .wpforms-field-name .wpforms-field-row .wpforms-field-row-block {
  width: 100% !important;
...
#wpforms-form-1815 .wpforms-field-name .wpforms-field-row input,
#wpforms-form-1843 .wpforms-field-name .wpforms-field-row input {
  width: 100% !important;
}
